...
from gbp_tempest_plugin.services.gbp.v2.json.service_chain_spec import ServiceChainSpecClient
...
class ManagerV2(clients.Manager):
    ...
    def _init_clients(self, params):
        ...
        self.service_chain_spec_client = ServiceChainSpecClient(**params)
